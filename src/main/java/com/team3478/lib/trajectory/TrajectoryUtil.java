...
import com.team3478.lib.geometry.*;
import com.team3478.lib.spline.PoseSpline;
import com.team3478.lib.spline.QuinticHermitePoseSplineHolonomic;
import com.team3478.lib.spline.QuinticHermitePoseSplineNonholonomic;
import com.team3478.lib.spline.SplineGenerator;
import com.team3478.lib.trajectory.timing.TimedState;
...
public class TrajectoryUtil {
  ...
  public static Trajectory<Pose2dWithMotion> trajectoryFromWaypointsAndHeadings(
    ...
    for (int i = 1; i < waypoints.size(); ++i) {
      splines.add(
          new QuinticHermitePoseSplineHolonomic(
              waypoints.get(i - 1), waypoints.get(i), headings.get(i - 1), headings.get(i)));
    }
    QuinticHermitePoseSplineHolonomic.optimizeSpline(splines);
    return trajectoryFromSplines(splines, maxDx, maxDy, maxDTheta);
  }

  public static Trajectory<Pose2dWithMotion> trajectoryFromSplines(
      final List<? extends PoseSpline> splines, double maxDx, double maxDy, double maxDTheta) {
    List<Pose2dWithMotion> points =
        SplineGenerator.parameterizeSplines(splines, maxDx, maxDy, maxDTheta);
