...
// ///////////////////////////////////////////////////////////////////////////////
// // Description:
// //  * Clase para almacenar la clase que calcula la kinematica y la clase con los contsraisn
// kinematicos del robot (velocidad,acceleracion,velocidadAngular)
// // Authors: -
// // Notes:
// //  - Obtenido de: https://github.com/Team254/FRC-2023-Public
// ///////////////////////////////////////////////////////////////////////////////

import com.team3478.lib.geometry.ICourse2d;
import com.team3478.lib.geometry.ICurvature;
import com.team3478.lib.geometry.IHeadingRate;
import com.team3478.lib.geometry.IPose2d;
import com.team3478.lib.geometry.Rotation2d;
import com.team3478.lib.swerve.*;

public class SwerveDriveDynamicsConstraint<
        S extends IPose2d<S> & ICourse2d<S> & ICurvature<S> & IHeadingRate<S>>
  ...
  public SwerveDriveDynamicsConstraint(
      final SwerveDriveKinematics kinematics, final SwerveKinematicLimits limits) {
  ...
  public double getMaxVelocity(S state) {
    ...
    for (var module : module_states) {
      max_vel =
          Math.min(max_vel, limits_.kMaxDriveVelocity / Math.abs(module.speedMetersPerSecond));
    }
    /*
