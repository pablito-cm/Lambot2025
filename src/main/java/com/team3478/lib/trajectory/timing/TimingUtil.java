...
import com.team3478.lib.trajectory.DistanceView;
import com.team3478.lib.trajectory.Trajectory;
  ...
  public static <S extends State<S>> Trajectory<TimedState<S>> timeParameterizeTrajectory(
    ...
    for (int i = 0; i < states.size(); ++i) {
      ...
      while (true) {
        ...
        // LoggerManager.log(LogLevel.INFO,"(intermediate) i: " + i + ", " +
        // constraint_state.toString());
      }
      // LoggerManager.log(LogLevel.INFO,"i: " + i + ", " + constraint_state.toString());
