...
public class Pose2dWithMotion
  ...
  public String toCSVHeader() {
    ...
    builder.append(getPose().toCSVHeader());
    builder.append(",");
    builder.append("motion_direction_dx");
    builder.append(",");
    builder.append("motion_direction_dy");
    builder.append(",");
    builder.append("motion_direction_dtheta");
    builder.append(",");
    builder.append("curvature");
    builder.append(",");
    builder.append("curvature_ds");
