...
///////////////////////////////////////////////////////////////////////////////
// Description:
//  * A movement along an arc at constant curvature and velocity. We can use ideas from
// "differential calculus" to create
...
public class Twist2d implements Interpolable<Twist2d>, ICourse2d<Twist2d> {
  ...
  // Commented out to avoid confusion since we use Twists to refer to various things, some of which
  // have meaningful curvatures and others don't.
