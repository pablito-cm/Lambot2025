...
///////////////////////////////////////////////////////////////////////////////
// Description:
//  * A MotionProfileGenerator generates minimum-time MotionProfiles to travel from a given
...
import com.team3478.lib.motion.IMotionProfileGoal.CompletionBehavior;
...
public class MotionProfileGenerator {
  ...
  public static synchronized MotionProfile generateProfile(
    ...
    // goal state motion
    // onto the initial state and all constraints. Then add the goal state motion back to the
    // result.
    MotionState superposedPrevState =
        new MotionState(
            prev_state.t(),
            prev_state.pos(),
            prev_state.vel() - goal_state.max_vel(),
            prev_state.acc());
