...
public class SplineGenerator {
  ...
  public static List<Pose2dWithMotion> parameterizeSpline(
      PoseSpline s, double maxDx, double maxDy, double maxDTheta, double t0, double t1) {
  ...
  public static List<Pose2dWithMotion> parameterizeSpline(
      PoseSpline s, double maxDx, double maxDy, double maxDTheta) {
  ...
  public static List<Pose2dWithMotion> parameterizeSplines(
      List<? extends PoseSpline> splines, double maxDx, double maxDy, double maxDTheta) {
    List<Pose2dWithMotion> rv = new ArrayList<>();
  ...
  private static void getSegmentArc(
    ...
    Rotation2d course_predicted =
        (new Rotation2d(twist_full.dx, twist_full.dy, true))
