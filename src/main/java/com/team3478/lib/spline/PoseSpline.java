...
public abstract class PoseSpline {
  ...
  // inverse meters.
  // Curvature tells us how the motion direction is changing, whereas DHeading tells us how facing
  ...
  public Pose2dWithMotion getPose2dWithMotion(double t) {
    ...
    return new Pose2dWithMotion(
        getPose2d(t), motion_direction, getCurvature(t), getDCurvature(t) / getVelocity(t));
  }
}
