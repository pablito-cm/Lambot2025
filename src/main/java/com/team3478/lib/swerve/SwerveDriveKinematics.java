...
//  *
//  * <p>Forward kinematics (converting an array of module states into the overall chassis motion)
// is
...
//  * Moore-Penrose pseudoinverse of [moduleLocations] and then multiply by [moduleStates] to get
// our
//  * chassis speeds.
//  *
//  * <p>Forward kinematics is also used for odometry -- determining the position of the robot on
// the
...
public class SwerveDriveKinematics {
  ...
  public ChassisSpeeds toChassisSpeedWheelConstraints(SwerveModuleState... wheelStates) {
    ...
    for (int i = 0; i < m_numModules; i++) {
      ...
      // LoggerManager.log(LogLevel.INFO,module);
    ...
    // LoggerManager.log(LogLevel.INFO,constraintsMatrix);
    ...
    // LoggerManager.log(LogLevel.INFO,enforcedConstraints);
  ...
  public static ChassisSpeeds compensateForSkew(ChassisSpeeds speeds) {
    ...
    Translation2d t =
        new Translation2d(speeds.vxMetersPerSecond, speeds.vyMetersPerSecond)
            .rotateBy(Rotation2d.fromDegrees(Math.signum(-speeds.omegaRadiansPerSecond) * 90.0));
